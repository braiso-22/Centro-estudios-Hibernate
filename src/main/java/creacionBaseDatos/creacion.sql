...
create table detalle_clase(alumno int, profesor int, asignatura varchar(20), primary key (alumno, profesor, asignatura), foreign key (alumno) references alumno(id),
